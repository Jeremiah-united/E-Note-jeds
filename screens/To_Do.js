...
const AndroidLarge4 = () => {
  	...
  	return (
    		<View style={styles.androidLarge16}>
      			...
      			<Pressable style={[styles.ellipseParent, styles.wrapperLayout]} onPress={()=>{}}>
        				<Image style={[styles.groupChild, styles.wrapperLayout]} resizeMode="cover" source="Ellipse 41.png" />
      			...
      			<Image style={[styles.androidLarge16Child, styles.toDoPosition]} resizeMode="cover" source="Group 100.png" />
      			<Pressable style={[styles.container, styles.wrapperLayout]} onPress={()=>{}}>
        				<Image style={styles.icon} resizeMode="cover" source="Group 102.png" />
      			</Pressable>
      			<Text style={[styles.toDo, styles.toDoPosition]}>{`To Do `}</Text>
      			<Image style={styles.androidLarge16Item} resizeMode="cover" source="Group 104.png" />
      			<Pressable style={[styles.backArrrow, styles.wrapperLayout]} onPress={()=>{}}>
        				<Image style={[styles.groupChild, styles.wrapperLayout]} resizeMode="cover" source="Ellipse 23.png" />
        				<View style={[styles.groupView, styles.groupPosition]}>
          					<View style={[styles.groupChild5, styles.groupChildLayout]} />
          					<View style={[styles.groupChild6, styles.groupChildLayout]} />
        				</View>
      			</Pressable>
      			<View style={[styles.androidLarge16Inner, styles.groupInnerLayout]} />
    		</View>);
};
